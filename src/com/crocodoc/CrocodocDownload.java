...
class CrocodocDownload extends Crocodoc {
	 ...
	 * @throws CrocodocException 
	 */
	public static HttpEntity document(String uuid, Boolean isPdf, Boolean isAnnotated) throws CrocodocException {
	 ...
	 * @param bool isPdf Should the file be downloaded as a PDF?
	 * @param bool isAnnotated Should the file be downloaded with annotations?
	 * @param array filter Which annotations should be included if any as a
	 *   list
	 * 
	 * @return object An HttpEntity of the downloaded file
	 * @throws CrocodocException 
	 */
	public static HttpEntity document(String uuid, Boolean isPdf, Boolean isAnnotated, List<String> filter) throws CrocodocException {
	 ...
	 * @param bool isPdf Should the file be downloaded as a PDF?
	 * @param bool isAnnotated Should the file be downloaded with annotations?
	 * @param string filter Which annotations should be included if any as a
	 * 	 comma-separated list of user IDs as the filter
	 * 
	 * @return object An HttpEntity of the downloaded file
	 * @throws CrocodocException 
	 */
	public static HttpEntity document(String uuid, Boolean isPdf, Boolean isAnnotated, String filter) throws CrocodocException {
	 ...
	 * 
	 * @param string uuid The uuid of the file to download the thumbnail from
	 * @param string size WIDTHxHEIGHT (integer X integer)
	 * 
	 * @return object An HttpEntity of the downloaded file
	 * @throws CrocodocException 
	 */
	public static HttpEntity thumbnail(String uuid, String size) throws CrocodocException {
		Map<String, Object> getParams = new HashMap<String, Object>();
		getParams.put("uuid", uuid);
	 ...
	 * @throws CrocodocException 
	 */
	public static HttpEntity thumbnail(String uuid, Integer width, Integer height) throws CrocodocException {
		String size = null;
